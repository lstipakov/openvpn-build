...
define([PRODUCT_OVPN_DCO_VERSION],     [1.3.1])
...
define([PACKAGE_VERSION], [2.6.14-I001])
...
define([PRODUCT_VERSION], [2.6.1401])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{CD1DCDF3-BCAC-4233-A1CC-5DAFEE1E604E}])
