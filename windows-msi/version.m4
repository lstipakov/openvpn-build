...
define([PRODUCT_TAP_WIN_URL_x86],      [https://github.com/lstipakov/tap-windows6/releases/download/9.25.1/tap-windows-9.25.1-I0-i386.msm])
define([PRODUCT_TAP_WIN_URL_amd64],    [https://github.com/lstipakov/tap-windows6/releases/download/9.25.1/tap-windows-9.25.1-I0-amd64.msm])
define([PRODUCT_TAP_WIN_URL_arm64],    [https://github.com/lstipakov/tap-windows6/releases/download/9.25.1/tap-windows-9.25.1-I0-arm64.msm])
...
define([PACKAGE_VERSION], [2.6.3-I002])
...
define([PRODUCT_VERSION], [2.6.302])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{2777494D-1885-4BF3-9B16-C3D176033BBE}])
