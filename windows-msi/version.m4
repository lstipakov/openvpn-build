...
define([PRODUCT_TAP_WIN_URL_x86],      [https://build.openvpn.net/downloads/releases/tap-windows-9.24.7-I601-i386.msm])
define([PRODUCT_TAP_WIN_URL_amd64],    [https://build.openvpn.net/downloads/releases/tap-windows-9.24.7-I601-amd64.msm])
define([PRODUCT_TAP_WIN_URL_arm64],    [https://build.openvpn.net/downloads/releases/tap-windows-9.24.7-I601-arm64.msm])
...
define([PACKAGE_VERSION], [2.5.8-I603])
...
define([PRODUCT_VERSION], [2.5.039])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{4DC5E5B0-0BC0-4A2B-B118-1F2E3796E8A4}])
