...
define([PRODUCT_TAP_WIN_URL_arm64],    [https://build.openvpn.net/downloads/releases/tap-windows-9.24.6-I601-i386.msm])
...
define([PRODUCT_WINTUN_URL_arm64],     [https://www.wintun.net/builds/wintun-x86-0.8.1.msm])
...
define([PACKAGE_VERSION], [2.6-dco-win-preview])
...
define([PRODUCT_VERSION], [2.6.023])

dnl The MSI product code MUST change on each product release.
define([PRODUCT_CODE], [{A85524CE-83E4-442A-973B-7038C65A9243}])
